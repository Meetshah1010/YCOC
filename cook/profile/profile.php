              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <?php
                    echo '<img style="border: 3px solid; border-radius:50px; white;height:100px;width:100px;" class="zoomA" src="data:image/jpeg;base64,'.base64_encode($image['img'] ).'" />';
                    ?>
                    <div class="mt-3">
                        <?php
...
-->
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                ...
                <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Cook ID</h6>
                    </div>
                    <?php
                    echo '<div class="col-sm-9 text-secondary">'.$cook['cid'].'</div>';
                    ?>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <?php
                    echo '<div class="col-sm-9 text-secondary">'.$cook['cemail'].'</div>';
                    ?>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <?php
                    echo '<div class="col-sm-9 text-secondary">'.$cook['caddress'].'</div>';
                    ?>
                  </div>
                </div>
              </div>

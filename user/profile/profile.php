...
<body>
    ...
    <div class="container-sm" style="margin: 0px 146px 0px 146px;">
        ...
        <div class="profileedit">
            <button type="button" data-bs-toggle="modal" data-bs-target="#ModalLoginForm" class="edit" tabindex="0" aria-disabled="false"><span tabindex="-1" class="sc-1kx5g6g-2 gylDKm"><i class="rbbb40-1 MxLSp sc-1kx5g6g-0 gyojlT" color="#FFFFFF" size="10"><svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" width="10" height="10" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" class="rbbb40-0 fdFvgA">
    ...
    <div class="leftpanel">
        ...
        <div class=" leftitem"><a style="color: red;" class="a" onClick="getclassname(this.getAttribute('class'));">Address</a></div>

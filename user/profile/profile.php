...
<body>
    ...
    <div class="container-sm" style="margin: 0px 146px 0px 146px;">
        ...
        <div class="profileedit">
            <button type="button" data-bs-toggle="modal" data-bs-target="#ModalLoginForm" class="edit" tabindex="0" aria-disabled="false"><span tabindex="-1" class="sc-1kx5g6g-2 gylDKm"><i class="rbbb40-1 MxLSp sc-1kx5g6g-0 gyojlT" color="#FFFFFF" size="10" style="margin-right: 6px;

...
<body>
    ...
    <div class="container-sm" style="margin: 0px 146px 0px 146px;">
        <div class="profilebg">
            ...
            echo '<a href="../changepic/changepic.html" target="_blank">
                        <div class="overlay"style="transform: translateY(247%) translateX(165%);">
                            <div class="circle"></div>
                            <img src="https://img.icons8.com/metro/26/000000/camera.png"/>
                        
                        </div></a></div>';
            echo '  <div style="margin-top:45px; margin-left:170px;position:absolute; float:right;">
        ...
        <div class="profileedit">
            <button data-toggle="modal" data-target="#ModalLoginForm" class="edit" role="button" tabindex="0" aria-disabled="false"><span tabindex="-1" class="sc-1kx5g6g-2 gylDKm"><i class="rbbb40-1 MxLSp sc-1kx5g6g-0 gyojlT" color="#FFFFFF" size="10" style="margin-right: 6px;
    position:relative;"><svg id="editicon" xmlns="http://www.w3.org/2000/svg" style=" position:absolute;top:8px; right:-4px;" fill="#FFFFFF" width="10" height="10" viewBox="0 0 20 20" aria-labelledby="icon-svg-title- icon-svg-desc-" role="img" class="rbbb40-0 fdFvgA">
    ...
    <div class="leftpanel">
        ...
        <div class=" leftitem"><a style="color: rgb(237, 90, 107);" class="a" onClick="getclassname(this.getAttribute('class'));">Address</a></div>
